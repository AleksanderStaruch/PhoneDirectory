...
public class Server extends Thread{
    ...
    public void run() {
        ...
        try {
            log("TCP_IP.Client connected: "+getClientInfo(clientSocket));
            ...
            while(czyGra){
                ...
                log("TCP_IP.Client: "+ClientName+" SENDS: "+command);
                boolean b;
                switch(command){
                    case "GET":
                        command=br.readLine();
            ...
            log("Error handling TCP_IP.Client " + ClientName + ": " + e);
        } finally {
            try {
                log("PLAYER clientSocket closing");
                clientSocket.close();
                log("Connection with TCP_IP.Client " + ClientName + " closed");
